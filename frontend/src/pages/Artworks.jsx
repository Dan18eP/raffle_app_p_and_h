...
export default function Artworks() {
  ...
  const openEditModal = (artwork = null) => {
    if (artwork) {
      ...
      // Las imágenes ahora vienen como URLs completas de Supabase
            ...
            >
              {a.image_url ? (
                <div className="artwork-thumb">
                  {/* Se elimina BASE_URL porque la URL ya es absoluta */}
        ...
        <div className="modal" onClick={() => setDetailArtwork(null)}>
          <div className="modal-box modal-box--detail" onClick={(e) => e.stopPropagation()}>
            ...
            {detailArtwork.image_url ? (
              <img src={detailArtwork.image_url} className="detail-image" alt={detailArtwork.name} />
            ) : (
          ...
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {imagePreview && !formData.remove_image && (
                <img src={imagePreview} className="preview" alt="Preview" style={{ maxWidth: '100%', marginTop: '10px', borderRadius: '8px' }} />
              )}
                  ...
                  <label>
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        else setImagePreview(editingArtwork.image_url);
                      }}
                    />
